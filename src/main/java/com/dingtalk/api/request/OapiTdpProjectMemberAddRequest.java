...
import com.dingtalk.api.response.OapiTdpProjectMemberAddResponse;
...
public class OapiTdpProjectMemberAddRequest extends BaseTaobaoRequest<OapiTdpProjectMemberAddResponse> {
	...
	* 用户ID
	...
	public Class<OapiTdpProjectMemberAddResponse> getResponseClass() {
		return OapiTdpProjectMemberAddResponse.class;
	}
