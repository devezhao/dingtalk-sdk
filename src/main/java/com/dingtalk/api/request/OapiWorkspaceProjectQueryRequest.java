...
import com.dingtalk.api.response.OapiWorkspaceProjectQueryResponse;
...
public class OapiWorkspaceProjectQueryRequest extends BaseTaobaoRequest<OapiWorkspaceProjectQueryResponse> {
	...
	public Class<OapiWorkspaceProjectQueryResponse> getResponseClass() {
		return OapiWorkspaceProjectQueryResponse.class;
	}
