...
public class OapiSmartworkHrmEmployeeUpdateRequest extends BaseTaobaoRequest<OapiSmartworkHrmEmployeeUpdateResponse> {
	...
	* 添加待入职入参
	...
	public static class EmpFieldVo extends TaobaoObject {
		private static final long serialVersionUID = 7568872716458768156L;
		/**
		 * 更新的字段code
		 */
		@ApiField("field_code")
	...
	public static class EmpListFieldVO extends TaobaoObject {
		private static final long serialVersionUID = 8721833493279499523L;
		/**
		 * 单个组所有字段
		 */
	...
	public static class GroupMetaInfo extends TaobaoObject {
		private static final long serialVersionUID = 1592832616165443861L;
		/**
		 * 需改的字段所在组ID
		 */
		@ApiField("group_id")
	...
	public static class PreEntryEmployeeAddParam extends TaobaoObject {
		private static final long serialVersionUID = 3592218846799697254L;
		/**
		 * 所有组明细
		 */
		@ApiListField("groups")
