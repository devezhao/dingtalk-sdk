...
import com.dingtalk.api.response.OapiCrmObjectdataFollowrecordQueryResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.crm.objectdata.followrecord.query request
 * 
 * @author top auto create
 * @since 1.0, 2021.03.11
 */
public class OapiCrmObjectdataFollowrecordQueryRequest extends BaseTaobaoRequest<OapiCrmObjectdataFollowrecordQueryResponse> {
	...
	* 查询条件
	...
	public Class<OapiCrmObjectdataFollowrecordQueryResponse> getResponseClass() {
		return OapiCrmObjectdataFollowrecordQueryResponse.class;
	}
