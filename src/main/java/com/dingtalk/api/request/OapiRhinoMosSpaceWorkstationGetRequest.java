...
import com.dingtalk.api.response.OapiRhinoMosSpaceWorkstationGetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.space.workstation.get request
 * 
 * @author top auto create
 * @since 1.0, 2020.03.07
 */
public class OapiRhinoMosSpaceWorkstationGetRequest extends BaseTaobaoRequest<OapiRhinoMosSpaceWorkstationGetResponse> {
	...
	* request
	...
	public void setRequest(ProdWorkstationConditionReq request) {
	...
	public Class<OapiRhinoMosSpaceWorkstationGetResponse> getResponseClass() {
		return OapiRhinoMosSpaceWorkstationGetResponse.class;
	}
	 ...
	 * @since 1.0, null
	 */
	public static class ProdWorkstationConditionReq extends TaobaoObject {
		private static final long serialVersionUID = 1888961661723279639L;
		/**
		 * 类目code
		 */
