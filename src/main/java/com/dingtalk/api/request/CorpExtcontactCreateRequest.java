...
import com.dingtalk.api.response.CorpExtcontactCreateResponse;

/**
 * TOP DingTalk-API: dingtalk.corp.extcontact.create request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.03
 */
public class CorpExtcontactCreateRequest extends BaseTaobaoRequest<CorpExtcontactCreateResponse> {
	...
	* 外部联系人信息
	...
	public Class<CorpExtcontactCreateResponse> getResponseClass() {
		return CorpExtcontactCreateResponse.class;
	}
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 3692715692891896843L;
		/**
		 * 地址
		 */
		@ApiField("address")
