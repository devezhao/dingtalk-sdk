...
/**
 * TOP DingTalk-API: dingtalk.oapi.ding.create request
 * 
 * @author top auto create
 * @since 1.0, 2019.11.18
 */
public class OapiDingCreateRequest extends BaseTaobaoRequest<OapiDingCreateResponse> {
	...
	* 通知内容
	...
	public void setAttachment(AttachmentVO attachment) {
		this.attachment = new JSONWriter(false,false,true).write(attachment);
	}
	...
	public Class<OapiDingCreateResponse> getResponseClass() {
		return OapiDingCreateResponse.class;
	}
	...
	public static class AttachmentVO extends TaobaoObject {
		private static final long serialVersionUID = 8848883117941585157L;
		/**
		 * 文件后缀, 用于展示文件对应图标
		 */
