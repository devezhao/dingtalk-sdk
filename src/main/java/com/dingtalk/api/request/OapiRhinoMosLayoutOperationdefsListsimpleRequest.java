...
import com.dingtalk.api.response.OapiRhinoMosLayoutOperationdefsListsimpleResponse;
...
public class OapiRhinoMosLayoutOperationdefsListsimpleRequest extends BaseTaobaoRequest<OapiRhinoMosLayoutOperationdefsListsimpleResponse> {
	...
	* 用户ID
	...
	public Class<OapiRhinoMosLayoutOperationdefsListsimpleResponse> getResponseClass() {
		return OapiRhinoMosLayoutOperationdefsListsimpleResponse.class;
	}
