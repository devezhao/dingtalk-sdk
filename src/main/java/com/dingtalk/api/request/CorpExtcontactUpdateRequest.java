...
import com.dingtalk.api.response.CorpExtcontactUpdateResponse;

/**
 * TOP DingTalk-API: dingtalk.corp.extcontact.update request
 * 
 * @author top auto create
 * @since 1.0, 2018.07.25
 */
public class CorpExtcontactUpdateRequest extends BaseTaobaoRequest<CorpExtcontactUpdateResponse> {
	...
	* 外部联系人信息
	...
	public Class<CorpExtcontactUpdateResponse> getResponseClass() {
		return CorpExtcontactUpdateResponse.class;
	}
	...
	public static class OpenExtContact extends TaobaoObject {
		private static final long serialVersionUID = 7571416234188378245L;
		/**
		 * 地址
		 */
		@ApiField("address")
