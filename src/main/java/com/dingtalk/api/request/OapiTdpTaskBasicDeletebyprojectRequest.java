...
import com.dingtalk.api.response.OapiTdpTaskBasicDeletebyprojectResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.task.basic.deletebyproject request
 * 
 * @author top auto create
 * @since 1.0, 2020.12.23
 */
public class OapiTdpTaskBasicDeletebyprojectRequest extends BaseTaobaoRequest<OapiTdpTaskBasicDeletebyprojectResponse> {
	...
	* 任务所属项目ID
	...
	public Class<OapiTdpTaskBasicDeletebyprojectResponse> getResponseClass() {
		return OapiTdpTaskBasicDeletebyprojectResponse.class;
	}
