...
import com.dingtalk.api.response.OapiSmartdeviceVisitorAddvisitorResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.smartdevice.visitor.addvisitor request
 * 
 * @author top auto create
 * @since 1.0, 2019.07.03
 */
public class OapiSmartdeviceVisitorAddvisitorRequest extends BaseTaobaoRequest<OapiSmartdeviceVisitorAddvisitorResponse> {
	...
	* 访客预约模型
	...
	public Class<OapiSmartdeviceVisitorAddvisitorResponse> getResponseClass() {
		return OapiSmartdeviceVisitorAddvisitorResponse.class;
	}
	...
	public static class DidoVisitorVo extends TaobaoObject {
		private static final long serialVersionUID = 2117418968738892856L;
		/**
		 * 预约开始时间
		 */
