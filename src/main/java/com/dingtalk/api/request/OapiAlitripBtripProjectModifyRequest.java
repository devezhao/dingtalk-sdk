...
import com.dingtalk.api.response.OapiAlitripBtripProjectModifyResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.alitrip.btrip.project.modify request
 * 
 * @author top auto create
 * @since 1.0, 2020.11.30
 */
public class OapiAlitripBtripProjectModifyRequest extends BaseTaobaoRequest<OapiAlitripBtripProjectModifyResponse> {
	...
	* 入参
	...
	public Class<OapiAlitripBtripProjectModifyResponse> getResponseClass() {
		return OapiAlitripBtripProjectModifyResponse.class;
	}
	...
	public static class OpenProjectRs extends TaobaoObject {
		private static final long serialVersionUID = 2565311252724398269L;
		/**
		 * 项目代码
		 */
		@ApiField("code")
