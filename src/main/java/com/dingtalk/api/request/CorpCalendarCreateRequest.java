...
/**
 * TOP DingTalk-API: dingtalk.corp.calendar.create request
 * 
...
public class CorpCalendarCreateRequest extends BaseTaobaoRequest<CorpCalendarCreateResponse> {
	...
	* 创建日程实体
	...
	public void setCreateVo(OpenCalendarCreateVo createVo) {
		this.createVo = new JSONWriter(false,true).write(createVo);
	}
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 2348118961173163865L;
		/**
		 * 距开始时多久进行提醒(单位:分钟)
		 */
		@ApiField("minutes")
	...
	public static class DatetimeVo extends TaobaoObject {
		private static final long serialVersionUID = 8228247674777648428L;
		/**
		 * 时区
		 */
		@ApiField("timezone")
	...
	public static class OpenCalendarSourceVo extends TaobaoObject {
		private static final long serialVersionUID = 6816361632586539856L;
		/**
		 * 日程来源
		 */
		@ApiField("title")
	...
	public static class OpenCalendarCreateVo extends TaobaoObject {
		private static final long serialVersionUID = 6713251826949852394L;
		/**
		 * 业务方自己的主键
		 */
		@ApiField("biz_id")
