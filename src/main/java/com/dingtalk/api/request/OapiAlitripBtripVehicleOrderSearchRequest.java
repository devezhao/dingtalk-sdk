...
import com.dingtalk.api.response.OapiAlitripBtripVehicleOrderSearchResponse;
...
public class OapiAlitripBtripVehicleOrderSearchRequest extends BaseTaobaoRequest<OapiAlitripBtripVehicleOrderSearchResponse> {
	...
	* 请求对象
	...
	public Class<OapiAlitripBtripVehicleOrderSearchResponse> getResponseClass() {
		return OapiAlitripBtripVehicleOrderSearchResponse.class;
	}
	...
	public static class OpenSearchRq extends TaobaoObject {
		private static final long serialVersionUID = 4234914997966932593L;
		/**
		 * false:仅搜索未报销订单
		 */
		@ApiField("all_apply")
