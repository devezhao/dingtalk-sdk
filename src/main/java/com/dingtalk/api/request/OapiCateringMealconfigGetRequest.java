...
import com.dingtalk.api.response.OapiCateringMealconfigGetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.catering.mealconfig.get request
 * 
 * @author top auto create
 * @since 1.0, 2021.03.10
 */
public class OapiCateringMealconfigGetRequest extends BaseTaobaoRequest<OapiCateringMealconfigGetResponse> {
	...
	* 获取未来n天的可点餐时间（包括今天）如： 1， 则返回今天和明天的可点餐日期，最大值为13
	...
	public Class<OapiCateringMealconfigGetResponse> getResponseClass() {
		return OapiCateringMealconfigGetResponse.class;
	}
