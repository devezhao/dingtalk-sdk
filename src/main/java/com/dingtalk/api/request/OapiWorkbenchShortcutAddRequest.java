...
import com.dingtalk.api.response.OapiWorkbenchShortcutAddResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.workbench.shortcut.add request
 * 
 * @author top auto create
 * @since 1.0, 2021.03.24
 */
public class OapiWorkbenchShortcutAddRequest extends BaseTaobaoRequest<OapiWorkbenchShortcutAddResponse> {
	...
	* 移动端快捷方式跳转地址(默认地址)
	...
	public Class<OapiWorkbenchShortcutAddResponse> getResponseClass() {
		return OapiWorkbenchShortcutAddResponse.class;
	}
	...
	public void check() throws ApiRuleException {
		...
		RequestCheckUtils.checkNotEmpty(shortcutUri, "shortcutUri");
	}
