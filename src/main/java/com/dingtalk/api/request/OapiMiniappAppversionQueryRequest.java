...
import com.dingtalk.api.response.OapiMiniappAppversionQueryResponse;
...
public class OapiMiniappAppversionQueryRequest extends BaseTaobaoRequest<OapiMiniappAppversionQueryResponse> {
	...
	* 查询参数
	...
	public Class<OapiMiniappAppversionQueryResponse> getResponseClass() {
		return OapiMiniappAppversionQueryResponse.class;
	}
