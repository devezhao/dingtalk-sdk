...
import com.dingtalk.api.response.OapiRhinoMosSpaceWorkstationUpsertResponse;
...
public class OapiRhinoMosSpaceWorkstationUpsertRequest extends BaseTaobaoRequest<OapiRhinoMosSpaceWorkstationUpsertResponse> {
	...
	* request
	...
	public void setRequest(ProdWorkstationUpsertDto request) {
	...
	public Class<OapiRhinoMosSpaceWorkstationUpsertResponse> getResponseClass() {
		return OapiRhinoMosSpaceWorkstationUpsertResponse.class;
	}
	...
	public static class ProdWorkstationUpsertDto extends TaobaoObject {
		private static final long serialVersionUID = 2784475598836947831L;
		/**
		 * 类目code
		 */
