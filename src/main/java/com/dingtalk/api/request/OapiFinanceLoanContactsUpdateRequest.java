...
import com.dingtalk.api.response.OapiFinanceLoanContactsUpdateResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.finance.loan.contacts.update request
 * 
 * @author top auto create
 * @since 1.0, 2021.01.19
 */
public class OapiFinanceLoanContactsUpdateRequest extends BaseTaobaoRequest<OapiFinanceLoanContactsUpdateResponse> {
	...
	* 联系人关系：配偶、父母、子女、朋友、同事、同学、其他家庭联系人、其他血亲、其他姻亲
	...
	public Class<OapiFinanceLoanContactsUpdateResponse> getResponseClass() {
		return OapiFinanceLoanContactsUpdateResponse.class;
	}
