...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.subject.delete request
 * 
 * @author top auto create
 * @since 1.0, 2020.10.14
 */
public class OapiEduSubjectDeleteRequest extends BaseTaobaoRequest<OapiEduSubjectDeleteResponse> {
	...
	* 学科名称
	...
	public Class<OapiEduSubjectDeleteResponse> getResponseClass() {
		return OapiEduSubjectDeleteResponse.class;
	}
	...
	public void check() throws ApiRuleException {
		...
		RequestCheckUtils.checkNotEmpty(subjectName, "subjectName");
	}
