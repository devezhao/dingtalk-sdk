...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.subject.create request
 * 
 * @author top auto create
 * @since 1.0, 2020.10.14
 */
public class OapiEduSubjectCreateRequest extends BaseTaobaoRequest<OapiEduSubjectCreateResponse> {
	...
	* 学科名称
	...
	public Class<OapiEduSubjectCreateResponse> getResponseClass() {
		return OapiEduSubjectCreateResponse.class;
	}
