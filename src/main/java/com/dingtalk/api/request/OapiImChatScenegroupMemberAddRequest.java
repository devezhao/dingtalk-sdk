...
/**
 * TOP DingTalk-API: dingtalk.oapi.im.chat.scenegroup.member.add request
 * 
 * @author top auto create
 * @since 1.0, 2020.09.26
 */
public class OapiImChatScenegroupMemberAddRequest extends BaseTaobaoRequest<OapiImChatScenegroupMemberAddResponse> {
	...
	* 成员userid
	...
	public Class<OapiImChatScenegroupMemberAddResponse> getResponseClass() {
		return OapiImChatScenegroupMemberAddResponse.class;
	}
