...
import com.dingtalk.api.response.OapiMedalCorpmedalQueryResponse;
...
public class OapiMedalCorpmedalQueryRequest extends BaseTaobaoRequest<OapiMedalCorpmedalQueryResponse> {
	...
	* 员工ID
	...
	public Class<OapiMedalCorpmedalQueryResponse> getResponseClass() {
		return OapiMedalCorpmedalQueryResponse.class;
	}

	public void check() throws ApiRuleException {
		RequestCheckUtils.checkMaxListSize(templateIds, 10, "templateIds");
