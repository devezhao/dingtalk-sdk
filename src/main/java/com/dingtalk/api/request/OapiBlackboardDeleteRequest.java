...
public class OapiBlackboardDeleteRequest extends BaseTaobaoRequest<OapiBlackboardDeleteResponse> {
	...
	/** 
	* 公告id,可以通过https:oapi.dingtalk.comblackboardlistids获取有效值
	 */
	...
	* 操作人userId(必须是公告管理员)
	...
	public Class<OapiBlackboardDeleteResponse> getResponseClass() {
		return OapiBlackboardDeleteResponse.class;
	}
