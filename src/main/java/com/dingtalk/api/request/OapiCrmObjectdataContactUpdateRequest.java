...
import com.dingtalk.api.response.OapiCrmObjectdataContactUpdateResponse;
...
public class OapiCrmObjectdataContactUpdateRequest extends BaseTaobaoRequest<OapiCrmObjectdataContactUpdateResponse> {
	...
	* 联系人数据
	...
	public Class<OapiCrmObjectdataContactUpdateResponse> getResponseClass() {
		return OapiCrmObjectdataContactUpdateResponse.class;
	}
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 4823516668876799791L;
		/**
		 * 负责人的用户ID
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 7225543417722729419L;
		/**
		 * 数据内容
		 */
		@ApiField("data")
