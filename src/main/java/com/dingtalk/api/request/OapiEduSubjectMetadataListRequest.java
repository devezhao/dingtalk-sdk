...
import com.dingtalk.api.response.OapiEduSubjectMetadataListResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.edu.subject.metadata.list request
 * 
 * @author top auto create
 * @since 1.0, 2020.10.14
 */
public class OapiEduSubjectMetadataListRequest extends BaseTaobaoRequest<OapiEduSubjectMetadataListResponse> {
	...
	* 排序方式 （0:正序，1:倒序）
	...
	public Class<OapiEduSubjectMetadataListResponse> getResponseClass() {
		return OapiEduSubjectMetadataListResponse.class;
	}
