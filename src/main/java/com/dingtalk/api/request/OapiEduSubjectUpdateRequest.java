...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.subject.update request
 * 
 * @author top auto create
 * @since 1.0, 2020.10.14
 */
public class OapiEduSubjectUpdateRequest extends BaseTaobaoRequest<OapiEduSubjectUpdateResponse> {
	...
	* 学科名称
	...
	public Class<OapiEduSubjectUpdateResponse> getResponseClass() {
		return OapiEduSubjectUpdateResponse.class;
	}
