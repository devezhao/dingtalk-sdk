...
import com.dingtalk.api.response.OapiTdpTasklistAddbyprojectResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.tasklist.addbyproject request
 * 
 * @author top auto create
 * @since 1.0, 2020.12.23
 */
public class OapiTdpTasklistAddbyprojectRequest extends BaseTaobaoRequest<OapiTdpTasklistAddbyprojectResponse> {
	...
	* 用户id
	...
	public Class<OapiTdpTasklistAddbyprojectResponse> getResponseClass() {
		return OapiTdpTasklistAddbyprojectResponse.class;
	}
