...
import com.dingtalk.api.response.OapiTdpTasklistHidebyprojectResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.tasklist.hidebyproject request
 * 
 * @author top auto create
 * @since 1.0, 2020.12.23
 */
public class OapiTdpTasklistHidebyprojectRequest extends BaseTaobaoRequest<OapiTdpTasklistHidebyprojectResponse> {
	...
	* 用户id
	...
	public Class<OapiTdpTasklistHidebyprojectResponse> getResponseClass() {
		return OapiTdpTasklistHidebyprojectResponse.class;
	}
