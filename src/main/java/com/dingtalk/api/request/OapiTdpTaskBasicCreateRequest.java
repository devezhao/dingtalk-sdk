...
import com.dingtalk.api.response.OapiTdpTaskBasicCreateResponse;
...
public class OapiTdpTaskBasicCreateRequest extends BaseTaobaoRequest<OapiTdpTaskBasicCreateResponse> {
	...
	* 请求入参
	...
	public Class<OapiTdpTaskBasicCreateResponse> getResponseClass() {
		return OapiTdpTaskBasicCreateResponse.class;
	}
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 1295451336954513861L;
		/**
		 * 评论数
		 */
	...
	public static class TaskCreate extends TaobaoObject {
		private static final long serialVersionUID = 6676795777782316763L;
		/**
		 * 创建者id, 传staffId（工号）
		 */
