...
import com.dingtalk.api.response.OapiKacDatavDeptDauListResponse;
...
public class OapiKacDatavDeptDauListRequest extends BaseTaobaoRequest<OapiKacDatavDeptDauListResponse> {
	...
	* 请求参数对象
	...
	public void setRequest(DeptDauSummaryRequest request) {
	...
	public Class<OapiKacDatavDeptDauListResponse> getResponseClass() {
		return OapiKacDatavDeptDauListResponse.class;
	}
	...
	public static class DeptDauSummaryRequest extends TaobaoObject {
		private static final long serialVersionUID = 7741237357938346838L;
		/**
