...
import com.dingtalk.api.response.OapiRhinoMosSpaceDeviceCheckInResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.space.device.check.in request
 * 
 * @author top auto create
 * @since 1.0, 2020.03.07
 */
public class OapiRhinoMosSpaceDeviceCheckInRequest extends BaseTaobaoRequest<OapiRhinoMosSpaceDeviceCheckInResponse> {
	...
	* param_prod_workstation_device_batch_check_req
	...
	public Class<OapiRhinoMosSpaceDeviceCheckInResponse> getResponseClass() {
		return OapiRhinoMosSpaceDeviceCheckInResponse.class;
	}
	...
	public static class ProdWorkstationDeviceBatchCheckReq extends TaobaoObject {
		private static final long serialVersionUID = 3626948787875318118L;
		/**
		 * 设备id列表
		 */
