...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.conditional.finish request
 * 
...
public class OapiRhinoMosExecPerformConditionalFinishRequest extends BaseTaobaoRequest<OapiRhinoMosExecPerformConditionalFinishResponse> {
	...
	* 执行员工列表
	...
	public void check() throws ApiRuleException {
		...
		RequestCheckUtils.checkMaxListSize(operationUids, 20, "operationUids");
	...
	public static class Source extends TaobaoObject {
		private static final long serialVersionUID = 4329293367921447453L;
		/**
		 * 实体来源ID
		 */
		@ApiField("source_id")
	...
	public static class EntityCondition extends TaobaoObject {
		private static final long serialVersionUID = 5129733985897354145L;
		/**
		 * 实体ID列表
		 */
