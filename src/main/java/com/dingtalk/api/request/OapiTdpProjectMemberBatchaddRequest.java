...
import com.dingtalk.api.response.OapiTdpProjectMemberBatchaddResponse;
...
public class OapiTdpProjectMemberBatchaddRequest extends BaseTaobaoRequest<OapiTdpProjectMemberBatchaddResponse> {
	...
	* 用户ID列表
	...
	public Class<OapiTdpProjectMemberBatchaddResponse> getResponseClass() {
		return OapiTdpProjectMemberBatchaddResponse.class;
	}
