...
/**
 * TOP DingTalk-API: dingtalk.oapi.edu.course.join request
 * 
 * @author top auto create
 * @since 1.0, 2021.05.27
 */
public class OapiEduCourseJoinRequest extends BaseTaobaoRequest<OapiEduCourseJoinResponse> {
	...
	* 操作用户id
	...
	public Map<String, String> getTextParams() {		
		...
		txtParams.put("join_role", this.joinRole);
	...
	public Class<OapiEduCourseJoinResponse> getResponseClass() {
		return OapiEduCourseJoinResponse.class;
	}
