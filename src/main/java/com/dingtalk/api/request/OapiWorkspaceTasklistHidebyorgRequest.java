...
import com.dingtalk.api.response.OapiWorkspaceTasklistHidebyorgResponse;
...
public class OapiWorkspaceTasklistHidebyorgRequest extends BaseTaobaoRequest<OapiWorkspaceTasklistHidebyorgResponse> {
	...
	* 用户id
	...
	public Class<OapiWorkspaceTasklistHidebyorgResponse> getResponseClass() {
		return OapiWorkspaceTasklistHidebyorgResponse.class;
	}
