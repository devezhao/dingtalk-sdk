...
import com.dingtalk.api.response.OapiFinanceLoanBankcardDeleteResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.finance.loan.bankcard.delete request
 * 
 * @author top auto create
 * @since 1.0, 2021.02.04
 */
public class OapiFinanceLoanBankcardDeleteRequest extends BaseTaobaoRequest<OapiFinanceLoanBankcardDeleteResponse> {
	...
	* 手机号
	...
	public Class<OapiFinanceLoanBankcardDeleteResponse> getResponseClass() {
		return OapiFinanceLoanBankcardDeleteResponse.class;
	}
