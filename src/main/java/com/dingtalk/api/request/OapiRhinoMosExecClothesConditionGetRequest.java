...
import com.dingtalk.api.response.OapiRhinoMosExecClothesConditionGetResponse;

/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.clothes.condition.get request
 * 
 * @author top auto create
 * @since 1.0, 2020.07.03
 */
public class OapiRhinoMosExecClothesConditionGetRequest extends BaseTaobaoRequest<OapiRhinoMosExecClothesConditionGetResponse> {
	...
	* 请求
	...
	public Class<OapiRhinoMosExecClothesConditionGetResponse> getResponseClass() {
		return OapiRhinoMosExecClothesConditionGetResponse.class;
	}
	...
	public static class Source extends TaobaoObject {
		private static final long serialVersionUID = 6528289113864394215L;
		/**
		 * source_id
		 */
		@ApiField("source_id")
	...
	public static class EntityCondition extends TaobaoObject {
		private static final long serialVersionUID = 4815615452516681695L;
		/**
		 * 实体id
		 */
	...
	public static class Page extends TaobaoObject {
		private static final long serialVersionUID = 5354817669962839432L;
		/**
		 * 页大小
		 */
		@ApiField("page_size")
	...
	public static class GetClothesConditionReq extends TaobaoObject {
		private static final long serialVersionUID = 5149889148188196531L;
		/**
		 * 实体条件
		 */
		@ApiField("condition")
