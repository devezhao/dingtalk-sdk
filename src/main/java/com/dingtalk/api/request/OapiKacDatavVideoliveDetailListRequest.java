...
public class OapiKacDatavVideoliveDetailListRequest extends BaseTaobaoRequest<OapiKacDatavVideoliveDetailListResponse> {
	...
	* 请求参数对象
	...
	public void setRequest(VideoLiveDetailRequest request) {
	...
	public Class<OapiKacDatavVideoliveDetailListResponse> getResponseClass() {
		return OapiKacDatavVideoliveDetailListResponse.class;
	}
	...
	public static class VideoLiveDetailRequest extends TaobaoObject {
		private static final long serialVersionUID = 2338672391173338763L;
		/**
