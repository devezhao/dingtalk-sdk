 ...
 */
public class OapiAlitripBtripCostCenterEntityAddRequest extends BaseTaobaoRequest<OapiAlitripBtripCostCenterEntityAddResponse> {
	...
	* 请求对象
	...
	public static class OpenOrgEntityDo extends TaobaoObject {
		private static final long serialVersionUID = 2383283756881732184L;
		/**
		 * 员工部门角色id
		 */
		@ApiField("entity_id")
	...
	public static class OpenCostCenterAddEntityRq extends TaobaoObject {
		private static final long serialVersionUID = 6542343967884435592L;
		/**
		 * 企业id
		 */
		@ApiField("corpid")
