...
import com.dingtalk.api.response.OapiChatbotPictureurlGetResponse;
...
public class OapiChatbotPictureurlGetRequest extends BaseTaobaoRequest<OapiChatbotPictureurlGetResponse> {
	...
	* 图片临时下载码
	...
	public Class<OapiChatbotPictureurlGetResponse> getResponseClass() {
		return OapiChatbotPictureurlGetResponse.class;
	}

	public void check() throws ApiRuleException {
		RequestCheckUtils.checkNotEmpty(downloadCode, "downloadCode");
		RequestCheckUtils.checkMaxLength(downloadCode, 4000, "downloadCode");
	}
