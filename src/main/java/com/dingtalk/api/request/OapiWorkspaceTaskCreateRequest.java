...
public class OapiWorkspaceTaskCreateRequest extends BaseTaobaoRequest<OapiWorkspaceTaskCreateResponse> {
	...
	* 请求入参
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 3126775826353296949L;
		/**
		 * APP 跳转连接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 7762133846956649365L;
		/**
		 * 评论数
		 */
	...
	public static class TaskCreate extends TaobaoObject {
		private static final long serialVersionUID = 4252482637268583291L;
		/**
