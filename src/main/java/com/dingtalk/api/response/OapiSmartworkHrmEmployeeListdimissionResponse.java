...
public class OapiSmartworkHrmEmployeeListdimissionResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7886828967142479142L;
	...
	public static class EmpDeptVO extends TaobaoObject {
		private static final long serialVersionUID = 8311447237611548751L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class EmpDimissionInfoVo extends TaobaoObject {
		private static final long serialVersionUID = 7355271763667615161L;
		/**
		 * 离职部门列表
		 */
