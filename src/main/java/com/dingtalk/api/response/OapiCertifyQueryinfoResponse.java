...
/**
 * TOP DingTalk-API: dingtalk.oapi.certify.queryinfo response.
 * 
...
public class OapiCertifyQueryinfoResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7627453513144533216L;
	...
	public static class YunQi2018CertifyVO extends TaobaoObject {
		private static final long serialVersionUID = 6444165157781312785L;
		/**
		 * 实名时的脸图
		 */
