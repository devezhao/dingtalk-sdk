...
public class OapiAlitripBtripApplySearchResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4649844593764678471L;
	...
	public static class OpenItineraryInfo extends TaobaoObject {
		private static final long serialVersionUID = 4662381354974698324L;
		/**
		 * 到达城市
		 */
		@ApiField("arr_city")
	...
	public static class OpenUserInfo extends TaobaoObject {
		private static final long serialVersionUID = 8843247963386434886L;
		/**
		 * 用户名称
		 */
		@ApiField("user_name")
	...
	public static class OpenApproverInfo extends TaobaoObject {
		private static final long serialVersionUID = 8163425255396353463L;
		/**
		 * 审批意见
		 */
		@ApiField("note")
	...
	public static class OpenApplyRs extends TaobaoObject {
		private static final long serialVersionUID = 5582435173955493215L;
		/**
		 * 商旅审批展示id
		 */
