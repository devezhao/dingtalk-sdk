...
public class OapiWikiRepoListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1625872621919213779L;
	...
	public static class OpenRepoVo extends TaobaoObject {
		private static final long serialVersionUID = 4273289752436667325L;
		/**
		 * 知识库的描述
		 */
		@ApiField("desc")
	...
	public static class OpenPageResult extends TaobaoObject {
		private static final long serialVersionUID = 8342123531945255571L;
		/**
		 * 知识本列表
		 */
		@ApiListField("data")
