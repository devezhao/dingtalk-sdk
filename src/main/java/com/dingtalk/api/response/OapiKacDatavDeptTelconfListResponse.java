...
public class OapiKacDatavDeptTelconfListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5297732514494946526L;
	...
	public static class TelConferenceDeptSummaryVo extends TaobaoObject {
		private static final long serialVersionUID = 8771418752484121729L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class TelConferenceDeptSummaryResponse extends TaobaoObject {
		private static final long serialVersionUID = 6859136835972877931L;
		/**
		 * data
		 */
		@ApiListField("data")
