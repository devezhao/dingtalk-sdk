...
public class OapiEduCertGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2541516776184135458L;
	...
	public static class Certdata extends TaobaoObject {
		private static final long serialVersionUID = 5275465686535315333L;
		/**
	...
	public static class OpenPracticalTaskData extends TaobaoObject {
		private static final long serialVersionUID = 2393663192693154127L;
		/**
		 * true表示完成，false表示未完成
		 */
		@ApiField("finish")
	...
	public static class OpenQueryCertResponse extends TaobaoObject {
		private static final long serialVersionUID = 4533294185788944191L;
		/**
		 * 认证明细
		 */
