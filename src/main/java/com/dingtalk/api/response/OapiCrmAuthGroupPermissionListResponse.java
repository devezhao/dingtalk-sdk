...
public class OapiCrmAuthGroupPermissionListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1275863284263775515L;
	...
	public static class OperateScope extends TaobaoObject {
		private static final long serialVersionUID = 7867628822161678784L;
		/**
		 * 是否有权限
		 */
		@ApiField("has_auth")
	...
	public static class DeptInfo extends TaobaoObject {
		private static final long serialVersionUID = 4446895318613375785L;
		/**
		 * 部门id
		 */
		@ApiField("dept_id")
	...
	public static class StaffInfo extends TaobaoObject {
		private static final long serialVersionUID = 4649745327474422236L;
		/**
		 * 员工名称
		 */
		@ApiField("name")
	...
	public static class Ext extends TaobaoObject {
		private static final long serialVersionUID = 4789828166863614978L;
		/**
		 * 管理部门信息
		 */
	...
	public static class ManageScope extends TaobaoObject {
		private static final long serialVersionUID = 2666399426265652666L;
		/**
		 * 扩展内容
		 */
		@ApiField("ext")
	...
	public static class AuthObjects extends TaobaoObject {
		private static final long serialVersionUID = 4673137544498997961L;
		/**
		 * 表单名称
		 */
		@ApiField("label")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 2565265414699299832L;
		/**
		 * 权限内容
		 */
