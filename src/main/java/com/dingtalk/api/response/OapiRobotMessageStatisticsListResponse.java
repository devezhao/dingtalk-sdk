...
public class OapiRobotMessageStatisticsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2227855858486322924L;
	...
	public static class MsgStatResVo extends TaobaoObject {
		private static final long serialVersionUID = 1638616692931596933L;
		/**
		 * 机器人消息推送Id
		 */
		@ApiField("push_id")
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 7161876229568287318L;
		/**
		 * 当前页数
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6835549119494565159L;
		/**
		 * list
		 */
		@ApiListField("list")
