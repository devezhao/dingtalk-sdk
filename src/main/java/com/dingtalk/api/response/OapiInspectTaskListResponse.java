...
public class OapiInspectTaskListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3555633582467868759L;
	...
	public static class TopInspectTaskVo extends TaobaoObject {
		private static final long serialVersionUID = 6351918294543474448L;
		/**
		 * 签到时间戳，单位毫秒
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6467442964723737986L;
		/**
		 * 是否还有数据
		 */
		@ApiField("has_more")
