...
public class OapiCalendarListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5588967716521536196L;
	...
	public static class Attendees extends TaobaoObject {
		private static final long serialVersionUID = 1413267895945379466L;
		/**
		 * 展示姓名
		 */
	...
	public static class User extends TaobaoObject {
		private static final long serialVersionUID = 3579154245676944212L;
		/**
		 * 展示姓名
		 */
		@ApiField("display_name")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 6145776586293461331L;
		/**
	...
	public static class Items extends TaobaoObject {
		private static final long serialVersionUID = 8422523692662373674L;
		/**
		 * 参与者,考虑性能问题，该字段不向外透出
		 */
	...
	public static class OpenCalendarListResponse extends TaobaoObject {
		private static final long serialVersionUID = 1618314169197259729L;
		/**
		 * 日程的实体
		 */
		@ApiListField("items")
