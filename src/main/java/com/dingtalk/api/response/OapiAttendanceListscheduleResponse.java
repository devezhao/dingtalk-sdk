...
public class OapiAttendanceListscheduleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5726723947595567682L;
	...
	public static class AtScheduleForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3431146834874899745L;
		/**
	...
	public static class AtScheduleListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 6582155248436862772L;
		/**
		 * 分页用，表示是否还有下一页
		 */
		@ApiField("has_more")
