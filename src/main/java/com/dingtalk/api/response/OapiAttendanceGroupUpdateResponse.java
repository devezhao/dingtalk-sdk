...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.group.update response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiAttendanceGroupUpdateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2247197751935616449L;
	...
	public static class Group extends TaobaoObject {
		private static final long serialVersionUID = 1581761717418211742L;
		/**
		 * 是否开启拍照打卡，默认false
		 */
