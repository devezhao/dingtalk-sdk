...
/**
 * TOP DingTalk-API: dingtalk.oapi.crm.app.create response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiCrmAppCreateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2281716817645313885L;
	...
	public static class GetCrmMicroAppResponse extends TaobaoObject {
		private static final long serialVersionUID = 7436123935751264226L;
		/**
		 * agentid
		 */
		@ApiField("agentid")
