...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdef.get response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosLayoutOperationdefGetResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1398119881418468939L;
	 ...
	 */
	@ApiField("result")
	private OperationDefDto result;
	...
	public void setResult(OperationDefDto result) {
		this.result = result;
	}
	public OperationDefDto getResult( ) {
		return this.result;
	}
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8789751968776337414L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1693387989352192373L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 2441548199671798732L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 3432616694794888746L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 3415133798193946859L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 2896365224567273674L;
		/**
		 * 适用尺码
		 */
