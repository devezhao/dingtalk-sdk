...
public class OapiProcessinstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4517912518761849666L;
	...
	public static class FormComponentValueVo extends TaobaoObject {
		private static final long serialVersionUID = 2567462799468985886L;
		/**
		 * 组件类型
		 */
	...
	public static class ProcessInstanceTopVo extends TaobaoObject {
		private static final long serialVersionUID = 8614812674927648479L;
		/**
		 * 审批人列表
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6429155787642533843L;
		/**
		 * list
		 */
		@ApiListField("list")
