...
public class OapiCollectionInstanceListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3557488512214726829L;
	...
	public static class FormData extends TaobaoObject {
		private static final long serialVersionUID = 6637796968352982117L;
		/**
		 * 表单控件key
		 */
		@ApiField("key")
	...
	public static class FormInstanceResponse extends TaobaoObject {
		private static final long serialVersionUID = 1862518194644613828L;
		/**
		 * 毫秒级时间戳，填表提交时间
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 2831983911524815858L;
		/**
		 * 是否还有下一页
		 */
		@ApiField("has_more")
