...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.group.get response.
 * 
...
public class OapiAttendanceGroupGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7894952494787824326L;
	...
	public static class Group extends TaobaoObject {
		private static final long serialVersionUID = 8333347543743348729L;
		/**
		 * 是否开启拍照打卡，默认false
		 */
