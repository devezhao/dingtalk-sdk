...
/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.task.basic.create response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiTdpTaskBasicCreateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 6291246736456588925L;
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 8563316831543668758L;
		/**
		 * 评论数量
		 */
	...
	public static class OrgTask extends TaobaoObject {
		private static final long serialVersionUID = 5649313531442881246L;
		/**
		 * 归属企业id
		 */
