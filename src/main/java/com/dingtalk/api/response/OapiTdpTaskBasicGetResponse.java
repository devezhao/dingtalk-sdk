...
/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.task.basic.get response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiTdpTaskBasicGetResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1769937887443262318L;
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 3717871923284964856L;
		/**
		 * 评论数
		 */
	...
	public static class OrgTask extends TaobaoObject {
		private static final long serialVersionUID = 5281424491982753555L;
		/**
		 * 归属企业id
		 */
