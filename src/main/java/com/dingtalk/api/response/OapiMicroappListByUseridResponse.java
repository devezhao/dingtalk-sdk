...
/**
 * TOP DingTalk-API: dingtalk.oapi.microapp.list_by_userid response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiMicroappListByUseridResponse extends TaobaoResponse {

	private static final long serialVersionUID = 8351266774123525566L;
	...
	public static class Applist extends TaobaoObject {
		private static final long serialVersionUID = 2365867624238439568L;
		/**
		 * 微应用实例化id
		 */
		@ApiField("agentId")
