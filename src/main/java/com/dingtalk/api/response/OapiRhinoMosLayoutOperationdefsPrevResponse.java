...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdefs.prev response.
 * 
...
public class OapiRhinoMosLayoutOperationdefsPrevResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4569688295975162263L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 3542714387122566652L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1114256931741421911L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 7476819956956444514L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4521551339594588187L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 8846697751517159533L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 8795288584884996657L;
		/**
		 * 适用尺码
		 */
