...
public class OapiRobotMessageStatisticsListbypushidResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8289967331652483897L;
	...
	public static class PaginationVo extends TaobaoObject {
		private static final long serialVersionUID = 2261536736533735183L;
		/**
		 * 当前页数
		 */
	...
	public static class MsgStatByPushIdResVo extends TaobaoObject {
		private static final long serialVersionUID = 5734691713712649746L;
		/**
		 * 群Id
		 */
	...
	public static class RobotMsgStatPageResponse extends TaobaoObject {
		private static final long serialVersionUID = 6616151863211476245L;
		/**
		 * list
		 */
		@ApiListField("list")
