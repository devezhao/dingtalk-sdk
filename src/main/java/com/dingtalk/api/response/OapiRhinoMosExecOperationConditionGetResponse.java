...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.operation.condition.get response.
 * 
...
public class OapiRhinoMosExecOperationConditionGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1867136289425792545L;
	...
	public static class ClothesDto extends TaobaoObject {
		private static final long serialVersionUID = 4596344761687523663L;
		/**
		 * 颜色id
		 */
		@ApiField("color_id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6169668667631287979L;
		/**
		 * 当前起始
		 */
