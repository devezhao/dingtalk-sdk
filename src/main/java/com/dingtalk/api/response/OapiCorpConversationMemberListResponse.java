...
public class OapiCorpConversationMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8559887737757523672L;
	...
	public static class OpenMemberModel extends TaobaoObject {
		private static final long serialVersionUID = 2679829811235648913L;
		/**
		 * 员工ID
		 */
		@ApiField("userid")
	...
	public static class OpenMemberListModel extends TaobaoObject {
		private static final long serialVersionUID = 2193283633517598676L;
		/**
		 * 成员信息
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 8253268887341823156L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
