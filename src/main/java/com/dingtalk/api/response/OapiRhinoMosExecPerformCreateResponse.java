...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.create response.
 * 
...
public class OapiRhinoMosExecPerformCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6383223246621316725L;
	...
	public static class OperationPerformDto extends TaobaoObject {
		private static final long serialVersionUID = 7728893474113548993L;
		/**
		 * 是否有效
		 */
		@ApiField("active")
