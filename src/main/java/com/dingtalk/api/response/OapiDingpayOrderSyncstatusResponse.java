...
public class OapiDingpayOrderSyncstatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3594779364548885816L;
	...
	public static class Orders extends TaobaoObject {
		private static final long serialVersionUID = 8124398392464592632L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class OrderSyncStatusOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 2626398148292387541L;
		/**
		 * orders
		 */
		@ApiListField("orders")
