...
public class OapiAttendanceClassGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7787836112438637773L;
	...
	public static class AtTimeVo extends TaobaoObject {
		private static final long serialVersionUID = 2783279424721136984L;
		/**
		 * 是否跨天
		 */
		@ApiField("across")
	...
	public static class AtClassSettingForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7877113889635623419L;
		/**
		 * classId
		 */
		@ApiField("class_id")
	...
	public static class AtSectionVo extends TaobaoObject {
		private static final long serialVersionUID = 6419395576359445591L;
		/**
		 * 时间段列表
		 */
		@ApiListField("times")
	...
	public static class AtClassForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 7259184655357832344L;
		/**
		 * 考勤组班次配置
		 */
