...
public class OapiRhinoHumanresEmployeeProductionteamListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2254767587286717849L;
	...
	public static class ProductionTeamList extends TaobaoObject {
		private static final long serialVersionUID = 1185216735164784394L;
		/**
		 * 生产组业务ID
		 */
		@ApiField("biz_id")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 4653682815444261792L;
		/**
		 * 部门邮箱
		 */
		@ApiField("bu_mail")
