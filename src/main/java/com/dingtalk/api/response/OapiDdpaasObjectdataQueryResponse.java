...
/**
 * TOP DingTalk-API: dingtalk.oapi.ddpaas.objectdata.query response.
 * 
...
public class OapiDdpaasObjectdataQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 3877895289619433655L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 7738567942976479466L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class Values extends TaobaoObject {
		private static final long serialVersionUID = 6813246818773282576L;
		/**
		 * 创建记录的用户昵称
		 */
	...
	public static class IterablePage extends TaobaoObject {
		private static final long serialVersionUID = 6466354321316238992L;
		/**
		 * 是否有下一页
		 */
		@ApiField("has_more")
