...
public class OapiAttendanceGroupMinimalismListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6342618459174176181L;
	...
	public static class TopMinimalismGroupVo extends TaobaoObject {
		private static final long serialVersionUID = 4887829498677171294L;
		/**
		 * 考勤组id
		 */
		@ApiField("id")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6885142357642274715L;
		/**
		 * 游标位置
		 */
		@ApiField("cursor")
