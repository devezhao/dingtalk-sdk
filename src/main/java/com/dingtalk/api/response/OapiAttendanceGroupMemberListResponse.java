...
public class OapiAttendanceGroupMemberListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6263745681332387658L;
	...
	public static class TopGroupMemberVo extends TaobaoObject {
		private static final long serialVersionUID = 7114378838251752722L;
		/**
		 * 0表示需要考勤，1表示无需考勤人员
		 */
		@ApiField("atc_flag")
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 1679345771154292353L;
		/**
		 * 游标
		 */
		@ApiField("cursor")
