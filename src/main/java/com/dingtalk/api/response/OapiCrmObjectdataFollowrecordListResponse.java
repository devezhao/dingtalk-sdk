...
/**
 * TOP DingTalk-API: dingtalk.oapi.crm.objectdata.followrecord.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiCrmObjectdataFollowrecordListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 6538389549784242479L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 7822742668818995591L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 7257523488798555817L;
		/**
		 * 记录创建人的昵称
		 */
