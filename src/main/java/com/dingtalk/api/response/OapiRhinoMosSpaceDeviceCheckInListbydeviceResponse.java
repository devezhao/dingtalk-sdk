...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.space.device.check.in.listbydevice response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosSpaceDeviceCheckInListbydeviceResponse extends TaobaoResponse {

	private static final long serialVersionUID = 3313969261357415965L;
	...
	public static class ProdWorkstationDeviceCheckDto extends TaobaoObject {
		private static final long serialVersionUID = 5258922385936586413L;
		/**
		 * 登入时间
		 */
