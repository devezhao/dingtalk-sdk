...
public class OapiWorkspaceProjectCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1754893542669626776L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 4389877732777181615L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenProjectMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 6481373353619227966L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
	...
	public static class OpenProjectDto extends TaobaoObject {
		private static final long serialVersionUID = 5445599685564391881L;
		/**
		 * 开放组织id
		 */
		@ApiField("corp_id")
