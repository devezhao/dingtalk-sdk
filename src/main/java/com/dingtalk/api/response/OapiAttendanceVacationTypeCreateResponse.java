...
public class OapiAttendanceVacationTypeCreateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8279983287141546141L;
	...
	public static class LeaveVisibilityRuleVo extends TaobaoObject {
		private static final long serialVersionUID = 1838877751576995377L;
		/**
	...
	public static class SubmitTimeRuleVo extends TaobaoObject {
		private static final long serialVersionUID = 6312861892271522479L;
		/**
	...
	public static class LeaveCertificate extends TaobaoObject {
		private static final long serialVersionUID = 1244791648623819988L;
		/**
		 * 超过多长时间需提供请假证明
		 */
		@ApiField("duration")
	...
	public static class LeaveTypeVo extends TaobaoObject {
		private static final long serialVersionUID = 1692716741483349562L;
		/**
		...
		private LeaveCertificate leaveCertificate;
		/**
		 * 假期类型唯一标识
		 */
		@ApiField("leave_code")
		...
		public LeaveCertificate getLeaveCertificate() {
