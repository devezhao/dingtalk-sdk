...
/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.task.basic.getbysourceid response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiTdpTaskBasicGetbysourceidResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2343531648142987114L;
	...
	public void setResult(OrgTask result) {
		this.result = result;
	}
	public OrgTask getResult( ) {
		return this.result;
	}
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 4769759121362391997L;
		/**
		 * 评论数
		 */
	 ...
	 * @since 1.0, null
	 */
	public static class OrgTask extends TaobaoObject {
		private static final long serialVersionUID = 3214483779596443741L;
		/**
		 * 归属企业id
		 */
