...
public class OapiSmartworkHrmMasterDeleteResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8348472983549768122L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 1858975397548889549L;
		/**
		 * 业务UK,唯一确定一条流水
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVo extends TaobaoObject {
		private static final long serialVersionUID = 7739636227311915761L;
		/**
		 * 是否全部成功
		 */
