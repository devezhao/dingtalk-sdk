...
/**
 * TOP DingTalk-API: dingtalk.oapi.catering.prededuct response.
 * 
...
public class OapiCateringPredeductResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1814186161863865699L;
	...
	public static class CateringOpenPreDeductResponse extends TaobaoObject {
		private static final long serialVersionUID = 3633812867772333424L;
		/**
		 * 已经预抵扣的金额
		 */
