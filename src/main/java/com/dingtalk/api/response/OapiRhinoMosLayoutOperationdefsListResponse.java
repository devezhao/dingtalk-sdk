...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdefs.list response.
 * 
...
public class OapiRhinoMosLayoutOperationdefsListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 7599654422129212741L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 4354765798656551832L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 1547852337748131927L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8676242462113242123L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 5732277438871396311L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 5459398183192744159L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 3182373966313395373L;
		/**
		 * 适用尺码
		 */
