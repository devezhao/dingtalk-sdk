...
public class OapiRhinoHumanresProductionteamQueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4481739631171373824L;
	...
	public static class EmpList extends TaobaoObject {
		private static final long serialVersionUID = 4436218889285113298L;
		/**
		 * 部门邮箱
		 */
		@ApiField("bu_mail")
	...
	public static class WeekdayConfigList extends TaobaoObject {
		private static final long serialVersionUID = 7518438924529535368L;
		/**
		 * 星期
		 */
		@ApiField("day")
	...
	public static class Model extends TaobaoObject {
		private static final long serialVersionUID = 2785771633528655492L;
		/**
		 * 业务ID
		 */
		@ApiField("biz_id")
