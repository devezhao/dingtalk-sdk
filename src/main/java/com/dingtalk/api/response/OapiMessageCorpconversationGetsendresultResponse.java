...
public class OapiMessageCorpconversationGetsendresultResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8789756916624732576L;
	...
	public static class SendForbiddenModel extends TaobaoObject {
		private static final long serialVersionUID = 6615883444695761149L;
		/**
		 * 流控code
		 */
		@ApiField("code")
	...
	public static class AsyncSendResult extends TaobaoObject {
		private static final long serialVersionUID = 5233157721183566332L;
		/**
		 * 发送失败的用户id
		 */
