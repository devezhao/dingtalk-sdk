...
public class OapiKacDatavVideoconfDetailListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 6351235628426387299L;
	...
	public static class McsDetailVo extends TaobaoObject {
		private static final long serialVersionUID = 3156728639218717726L;
		/**
		 * 会议id
		 */
		@ApiField("conf_id")
	...
	public static class McsDetailResponse extends TaobaoObject {
		private static final long serialVersionUID = 8155563614179339366L;
		/**
		 * data
		 */
		@ApiListField("data")
