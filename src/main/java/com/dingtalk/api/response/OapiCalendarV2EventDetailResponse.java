...
/**
 * TOP DingTalk-API: dingtalk.oapi.calendar.v2.event.detail response.
 * 
...
public class OapiCalendarV2EventDetailResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1398484351738817857L;
	...
	public static class Attendee extends TaobaoObject {
		private static final long serialVersionUID = 2679584265988756738L;
		/**
		 * 员工工号
		 */
		@ApiField("userid")
	...
	public static class DateTime extends TaobaoObject {
		private static final long serialVersionUID = 6783455242976295153L;
		/**
	...
	public static class OpenCalendarReminderVo extends TaobaoObject {
		private static final long serialVersionUID = 2724832687116911333L;
		/**
		 * 提醒方式.app表示应用内提醒
		 */
		@ApiField("method")
	...
	public static class LocationVo extends TaobaoObject {
		private static final long serialVersionUID = 2753125976236596265L;
		/**
		 * 经度
		 */
		@ApiField("latitude")
	...
	public static class Event extends TaobaoObject {
		private static final long serialVersionUID = 4583611145942381555L;
		/**
		 * 日程参与者
		 */
