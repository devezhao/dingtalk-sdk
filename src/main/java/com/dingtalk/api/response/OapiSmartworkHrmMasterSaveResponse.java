...
public class OapiSmartworkHrmMasterSaveResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 8791547866922242937L;
	...
	public static class Failresult extends TaobaoObject {
		private static final long serialVersionUID = 3344626863687149772L;
		/**
		 * 业务流水唯一标识，和入参一致
		 */
		@ApiField("biz_uk")
	...
	public static class IntegrateBatchResultVO extends TaobaoObject {
		private static final long serialVersionUID = 8135816962172314419L;
		/**
		 * 是否全部保存成功
		 */
