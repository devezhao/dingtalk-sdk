...
public class OapiDingpayBillBatchqueryResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1125628185728672261L;
	...
	public static class DingPayBillOpenBo extends TaobaoObject {
		private static final long serialVersionUID = 2867683963948529698L;
		/**
		 * 金额（单位：分）
		 */
		@ApiField("amount")
	...
	public static class BillBatchQueryOpenResponse extends TaobaoObject {
		private static final long serialVersionUID = 2724332657577679167L;
		/**
		 * billList
		 */
