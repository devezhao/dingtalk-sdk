...
public class OapiAttendanceGroupPositionsAddResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1746568294463561746L;
	...
	public static class Position extends TaobaoObject {
		private static final long serialVersionUID = 5833224186416914914L;
		/**
		 * 地址描述
		 */
		@ApiField("address")
	...
	public static class ErrorInfo extends TaobaoObject {
		private static final long serialVersionUID = 1776554351917267445L;
		/**
		 * 错误码
		 */
		@ApiField("code")
	...
	public static class Result extends TaobaoObject {
		private static final long serialVersionUID = 2527288947897887689L;
		/**
		 * 错误列表
		 */
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 4262565356238783532L;
		/**
		 * 错误码
		 */
		@ApiField("errcode")
