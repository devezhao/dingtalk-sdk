...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.layout.operationdefs.sectionfirst response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosLayoutOperationdefsSectionfirstResponse extends TaobaoResponse {

	private static final long serialVersionUID = 4616176335336264214L;
	...
	public static class OperationExecutorAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 8251781681421848723L;
		/**
		 * 工序执行器ID
		 */
	...
	public static class DeviceAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 3329492276388898393L;
		/**
		 * 设备ID
		 */
		@ApiField("device_id")
	...
	public static class WorkerAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 7318616823167277537L;
		/**
		 * 姓名
		 */
		@ApiField("name")
	...
	public static class WorkstationAssignDto extends TaobaoObject {
		private static final long serialVersionUID = 6898861368993545916L;
		/**
		 * 站位编码
		 */
	...
	public static class WorkUnitDto extends TaobaoObject {
		private static final long serialVersionUID = 3238679216767283164L;
		/**
		 * 设备分配列表
		 */
	...
	public static class OperationDefDto extends TaobaoObject {
		private static final long serialVersionUID = 6655223711383364524L;
		/**
		 * 适用尺码
		 */
