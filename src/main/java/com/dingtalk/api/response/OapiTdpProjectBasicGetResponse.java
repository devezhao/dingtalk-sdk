...
/**
 * TOP DingTalk-API: dingtalk.oapi.tdp.project.basic.get response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiTdpProjectBasicGetResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1144246359323928693L;
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 2331282121854273367L;
		/**
		 * 归属企业id
		 */
