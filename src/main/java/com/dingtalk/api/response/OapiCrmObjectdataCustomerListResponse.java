...
/**
 * TOP DingTalk-API: dingtalk.oapi.crm.objectdata.customer.list response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiCrmObjectdataCustomerListResponse extends TaobaoResponse {

	private static final long serialVersionUID = 1569867396432694297L;
	...
	public static class DataPermissionVo extends TaobaoObject {
		private static final long serialVersionUID = 1757225734851225657L;
		/**
		 * 负责人用户ID列表
		 */
	...
	public static class ObjectDataInstanceVo extends TaobaoObject {
		private static final long serialVersionUID = 7787893614625335277L;
		/**
		 * 记录创建人的昵称
		 */
