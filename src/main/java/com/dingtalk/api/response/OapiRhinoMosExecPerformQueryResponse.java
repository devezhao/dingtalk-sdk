...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.exec.perform.query response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRhinoMosExecPerformQueryResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2627285354819543221L;
	...
	public static class OperationPerformDto extends TaobaoObject {
		private static final long serialVersionUID = 6684567893299499973L;
		/**
		 * 是否有效
		 */
		@ApiField("active")
