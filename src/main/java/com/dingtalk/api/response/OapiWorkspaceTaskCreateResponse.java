...
/**
 * TOP DingTalk-API: dingtalk.oapi.workspace.task.create response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiWorkspaceTaskCreateResponse extends TaobaoResponse {

	private static final long serialVersionUID = 4284627995575996956L;
	...
	public static class TaskSystemProperty extends TaobaoObject {
		private static final long serialVersionUID = 4438282895493732817L;
		/**
		 * APP 跳转连接
		 */
		@ApiField("appUrl")
	...
	public static class TaskExtension extends TaobaoObject {
		private static final long serialVersionUID = 5588993339982773912L;
		/**
		 * 评论数量
		 */
	...
	public static class Task extends TaobaoObject {
		private static final long serialVersionUID = 4823667815362977761L;
		/**
		 * 归属企业id
		 */
