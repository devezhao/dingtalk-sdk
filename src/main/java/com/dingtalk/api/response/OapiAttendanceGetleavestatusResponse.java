...
public class OapiAttendanceGetleavestatusResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5824691329547554136L;
	...
	public static class LeaveStatusVO extends TaobaoObject {
		private static final long serialVersionUID = 1877468114244774354L;
		/**
	...
	public static class LeaveStatusListVO extends TaobaoObject {
		private static final long serialVersionUID = 5426839883811338791L;
		/**
		 * 是否有更多数据
		 */
		@ApiField("has_more")
