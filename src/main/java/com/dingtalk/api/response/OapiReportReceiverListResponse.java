...
/**
 * TOP DingTalk-API: dingtalk.oapi.report.receiver.list response.
 * 
...
public class OapiReportReceiverListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2681966546336597782L;
	...
	public static class ReportPageVo extends TaobaoObject {
		private static final long serialVersionUID = 4848919645518755394L;
		/**
		 * 是否还有下一页
		 */
		@ApiField("has_more")
