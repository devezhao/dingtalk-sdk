...
public class SmartworkAttendsListscheduleResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 2848953483479558162L;
	...
	public static class AtScheduleForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 3537833178157377769L;
		/**
	...
	public static class AtScheduleListForTopVo extends TaobaoObject {
		private static final long serialVersionUID = 5617361294389191246L;
		/**
		 * 分页用，表示是否还有下一页
		 */
		@ApiField("has_more")
	...
	public static class DingOpenResult extends TaobaoObject {
		private static final long serialVersionUID = 2869133634871625386L;
		/**
		 * dingOpenErrcode
		 */
