...
/**
 * TOP DingTalk-API: dingtalk.oapi.rhino.mos.space.workstation.get response.
 * 
...
public class OapiRhinoMosSpaceWorkstationGetResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 1517761988219145417L;
	...
	public static class ProdWorkstationDto extends TaobaoObject {
		private static final long serialVersionUID = 7161621578645282547L;
		/**
		 * 类目code
		 */
