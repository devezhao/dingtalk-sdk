...
public class OapiEduGuardianListResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 5129789828383391981L;
	...
	public static class GuardianRespone extends TaobaoObject {
		private static final long serialVersionUID = 7288366327732749424L;
		/**
		 * 家长ID
		 */
	...
	public static class PageResult extends TaobaoObject {
		private static final long serialVersionUID = 6765546834838375899L;
		/**
		 * 是否存在下一页
		 */
		@ApiField("has_more")
