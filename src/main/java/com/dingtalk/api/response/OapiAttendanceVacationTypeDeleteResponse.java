...
/**
 * TOP DingTalk-API: dingtalk.oapi.attendance.vacation.type.delete response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiAttendanceVacationTypeDeleteResponse extends TaobaoResponse {

	private static final long serialVersionUID = 2826435569183463964L;
	...
	public static class LeaveTypeVo extends TaobaoObject {
		private static final long serialVersionUID = 7249625768183286468L;
		/**
