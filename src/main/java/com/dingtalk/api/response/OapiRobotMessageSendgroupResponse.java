...
/**
 * TOP DingTalk-API: dingtalk.oapi.robot.message.sendgroup response.
 * 
 * @author top auto create
 * @since 1.0, null
 */
public class OapiRobotMessageSendgroupResponse extends TaobaoResponse {

	private static final long serialVersionUID = 5572395318775376683L;
	...
	public static class GroupMessageSendTopResponse extends TaobaoObject {
		private static final long serialVersionUID = 6223133256835767314L;
		/**
		 * 用于查询发送进度的唯一标识
		 */
