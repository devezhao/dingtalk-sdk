...
public class OapiWorkspaceUpdateResponse extends TaobaoResponse {
	...
	private static final long serialVersionUID = 4524252676376635434L;
	...
	public static class OpenTagDto extends TaobaoObject {
		private static final long serialVersionUID = 5727363731788621867L;
		/**
		 * 角色code
		 */
		@ApiField("code")
	...
	public static class OpenMemberDto extends TaobaoObject {
		private static final long serialVersionUID = 4731131553487852461L;
		/**
		 * 项目corpid
		 */
		@ApiField("corp_id")
	...
	public static class OpenWorkspaceDto extends TaobaoObject {
		private static final long serialVersionUID = 2194873189587291546L;
		/**
		 * 创建时间
		 */
